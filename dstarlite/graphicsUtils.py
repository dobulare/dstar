...
def begin_graphics(width=640, height=480, color=formatColor(0, 0, 0), title=None):
    ...
    # Bind to value-down and value-up events
...
# We bind to value-down and value-up events.

_keysdown = {}
_keyswaiting = {}
# This holds an unprocessed value release.  We delay value releases by up to
